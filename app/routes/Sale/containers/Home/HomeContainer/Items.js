...
export default class Items extends React.PureComponent {
  state = {
    order: Store.get(`sale.items.${this.props.n.sale.id}.order`, 'desc'),
    orderBy: Store.get(
      `sale.items.${this.props.n.sale.id}.orderBy`,
      'unitPrice',
    ),
  };
  ...
  handleRequestSort = (event, property) => {
    this.setState(prevState => {
      ...
      Store.set({
        [`sale.items.${this.props.n.sale.id}.order`]: order,
        [`sale.items.${this.props.n.sale.id}.orderBy`]: orderBy,
      });
  ...
  render() {
    ...
    const items = this.getItems(n.sale.items);
